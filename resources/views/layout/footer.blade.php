...
<div class="col-12 p-5 text-center" style="background: linear-gradient(rgb(4, 26, 57, 0.95), rgb(4, 26, 57, 0.95)), url({{ asset('img/dxiMe7.png')}});">
    <div class="row no-gutters d-flex justify-content-center">
        ...
        <div class="col-2 text-left text-white p-3 ">
            <h5 class="footer" style="margin-bottom: 12%">
                <b>SIDE MAP</b>
            </h5>
    ...
    <hr class="color" />
    <span class="text-black">Copyright © 2020 Pavo Communications Sdn. Bhd.(861312-T) All Rights Reserved.</span>
</div>
{{-- End Footer --}}