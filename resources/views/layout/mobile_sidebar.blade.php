  ...
  <div class="dropdown" style="width:100%;">
      <button type="button" id="dropdown_button" style="width:100%;border:0px;" class="text-left pr-4 pl-4 pt-3 pb-2 btn btn-outline-danger shadow-sm dropdown-toggle" data-toggle="dropdown">
        ...
        <svg width="16px" height="16px" viewBox="0 2 16 16" class="bi bi-house-door" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          </svg>&nbsp;Dashboard <svg width="1em" height="1em" viewBox="0 0 16 10" class="bi bi-chevron-up float-right rotate" fill="currentColor">
        ...
        <svg width="1em" height="1em" viewBox="0 2 16 16" class="bi bi-person" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
         ...
         </svg> &nbsp; My Profile <svg width="1em" height="1em" viewBox="0 0 16 10" class="bi bi-chevron-up float-right rotate" fill="currentColor">
          <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
        </svg>
        @elseif(Route::currentRouteName() == 'addon')
        <svg width="1em" height="1em" viewBox="0 2 16 16" class="bi bi-bucket" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
         ...
         </svg> &nbsp;Buy Add-Ons <svg width="1em" height="1em" viewBox="0 0 16 10" class="bi bi-chevron-up float-right rotate" fill="currentColor">
          <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
        </svg>
        @elseif(Route::currentRouteName() == 'member')
        <svg width="1em" height="1em" viewBox="0 2 16 16" class="bi bi-star" fill="currentColor" >
          ...
          </svg>&nbsp;My Membership <svg width="1em" height="1em" viewBox="0 0 16 10" class="bi bi-chevron-up float-right rotate" fill="currentColor">
              <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
            </svg>
        @endif
     &nbsp;
     {{-- {{ucfirst(Route::currentRouteName())}} --}}
      ...
      <div class="dropdown-menu">
        ...
        @if(Route::currentRouteName() != 'addon')
