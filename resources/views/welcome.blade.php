...
<div class="container-fluid p-0">
    ...
    <div class="col-12 p-0 d-block d-sm-block d-md-none " style="position: relative;">
        <div class="w-100" style="display: flex; align-items: center; min-height: 597px; background-position: center; background-attachment: scroll; background-size: cover; background-repeat: no-repeat; background-image: url({{ asset('img/mainpage/banner4_edited.png')}});">
